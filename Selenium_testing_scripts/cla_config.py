...
config11 = {
    ...
    #page_one
    'customer_name': 'qabed_cla_intl_1',
    'model_name': 'cla',
    'model_version': 1,
    'model_type': 'intl',
    #page_two
...
config12 = {
    ...
    #page_one
    'customer_name': 'qabed_cla_intl_2',
    'model_name': 'cla',
    'model_version': 1,
    'model_type': 'intl',
    #page_two
...
config_prd = [config1, config11]
config_us = [config1, config2, config3, config4]
config_intl = [config11, config12]
configs = [config1, config2, config3, config4, config11, config12]
